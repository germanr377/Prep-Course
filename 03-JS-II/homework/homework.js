...
function operadoresLogicos(num1, num2, num3) {
  ...
  if(num1*num2*num3===0){return 'Error'} else{

    if (num1<0  || num2<0  || num3<0){return'Hay negativos'};
    if ( num1>num2 && num1>num3 && num1>0){return 'Número 1 es mayor y positivo'};
    if (num3>num1 && num3>num2){num3++; return num3} else{return false};
...
function esPrimo(numero) {
  ...
  if (numero===1 || numero==0) {a=false} else{
  for ( i = 2 ; i < numero  ; i++ ) {

    if (numero%i===0){i= numero+1;a=false}
       }}
  return(a)
